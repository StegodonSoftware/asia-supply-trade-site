...
const connectApps = [
  ...
  },
  {
    ...
    link: "viber://chat?number=%2B66927644981",
  },
  {
    name: "Zalo",
      ...
      <div className="relative z-10">
          ...
          <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="text-xl font-semibold text-[var(--charcoal)]">
                Asia Supply & Trade -{" "}
                <strong>Site currently under construction</strong>
              </span>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-[var(--charcoal)]/80 mb-4">
                  Founded on over two decades of hands-on experience in Asian
        ...
        <section id="suppliers" className="py-16 px-4 bg-[var(--aqua)]/85">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <a
              href="mailto:contact@asiasupplytrade.com?subject=Supply%20Inquiry&body=Hello%20Asia%20Supply%20%26%20Trade,"
